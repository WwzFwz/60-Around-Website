...
// src/app/explore/[categories]/[id]/page.tsx
"use client";

import React from 'react';
import { useParams } from 'next/navigation';
import ViewPlacePage from './components/ViewPlace'; // Import the ViewPlacePage component
...
const PlacePage: React.FC = () => {
  ...
  // const {placeId} =Params.id  ?? "c2196275-b25b-4cd4-86d1-d752afda4ecd" as any;
  // const id = "c2196275-b25b-4cd4-86d1-d752afda4ecd"
  // console.log(placeId)
 
  // If no placeId is found in the URL, return an error or loading state
  if (!id) {
