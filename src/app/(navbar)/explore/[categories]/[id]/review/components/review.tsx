  ...
  return (
    <div className="p-6 relative">
      ...
      <div className="flex flex-col-reverse lg:flex-row justify-between">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center m-2">
                    ...
                    <span className="ml-2 text-lg font-bold text-[#124076]">
                      {review.isAnonymous ? 'Anonymous' : 'Joko'}
                    </span>
                  </div>
                ...
                <div className="flex flex-col lg:flex-row justify-between mt-2 m-4">
                  ...
                  {review.imageUrl && (
                    <Image
                      ...
                      onClick={() => openImageModal(review.imageUrl?review.imageUrl:'default_image.svg')}
                    />
                  )}
                </div>
              </div>
        ...
        <div className="w-full lg:w-1/5 lg:ml-auto lg:mr-0 mb-6 lg:mb-0 order-1 lg:order-none">  {/* Align to the top in small screen */}
